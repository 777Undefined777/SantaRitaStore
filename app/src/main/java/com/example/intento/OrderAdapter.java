...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.CommandViewHolder> {

    private Cursor mCursor;
    private List<CommandDetail> commandDetails;

    public OrderAdapter(Cursor cursor, List<CommandDetail> commandDetails) {
        mCursor = cursor;
